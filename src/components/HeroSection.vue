...
.cashback-label { opacity: 0.8; font-size: 12px; }
.cashback-amount { font-size: 16px;  font-weight: 800; color: #ffd54a; }
.cashback-tag { font-size: 12px; background:  rgba(255,255,255,0.2); padding: 2px 8px; border-radius: 20px;}
